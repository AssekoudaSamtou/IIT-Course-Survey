    ...
    <v-app>
        ...
        <div class="text-xs-center">
            <v-dialog v-model="dialog" width="500">
                ...
                <v-card>
                    <v-card-title class="headline grey lighten-2" primary-title>Classe form</v-card-title>
    ...
    export default {
        ...
        methods: {
            ...
            save: function () {
                ...
                if (this.crud_mode === "c") {
                    this.$http.post(`${this.$store.state.backendHostName}/services/save/classe`, data, {
                        headers: {
            ...
            remove: function () {
                for (let i = 0; i < this.classes.length; i++) {
                    if(this.classes[i].id === this.selectedRow) {
                        ...
                        this.$http.get(`${this.$store.state.backendHostName}/services/delete/classe/${this.selectedRow}`, {
                            params:{},
                            headers: {
                                'Authorization': `${this.$store.state.userInfo.tokenType} ${this.$store.state.userInfo.accessToken}`,
