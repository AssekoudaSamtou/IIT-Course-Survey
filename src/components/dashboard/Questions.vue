    ...
    <v-app>
        ...
        <div class="text-xs-center">
            <v-dialog v-model="dialog" width="500">
                ...
                <v-card>
                    <v-card-title class="headline grey lighten-2" primary-title>Question form</v-card-title>
    ...
    export default {
        ...
        methods: {
            ...
            save: function () {
                ...
                if (this.crud_mode === "c") {
                    this.$http.post(`${this.$store.state.backendHostName}/services/save/question`, data, {
                        headers: {
            ...
            remove: function () {
                for (let i = 0; i < this.questions.length; i++) {
                    if(this.questions[i].id === this.selectedRow) {
                        ...
                        this.$http.get(`${this.$store.state.backendHostName}/services/delete/question/${this.selectedRow}`, {
                            params:{},
                            headers: {
                                'Authorization': `${this.$store.state.userInfo.tokenType} ${this.$store.state.userInfo.accessToken}`,
                                'Content-Type': 'application/json',
        ...
        mounted() {
            ...
            this.$http.get(`${this.$store.state.backendHostName}/services/getAll/question`, {
                params:{},
                headers: {
                    'Authorization': `${this.$store.state.userInfo.tokenType} ${this.$store.state.userInfo.accessToken}`,
                    'Content-Type': 'application/json',
